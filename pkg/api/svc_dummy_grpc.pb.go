...
type DummyClient interface {
	Process(ctx context.Context, in *DummyRequest, opts ...grpc.CallOption) (*DumyResponse, error)
}
...
func (c *dummyClient) Process(ctx context.Context, in *DummyRequest, opts ...grpc.CallOption) (*DumyResponse, error) {
	out := new(DumyResponse)
	err := c.cc.Invoke(ctx, "/kubertest.Dummy/Process", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DummyServer interface {
	Process(context.Context, *DummyRequest) (*DumyResponse, error)
...
func (UnimplementedDummyServer) Process(context.Context, *DummyRequest) (*DumyResponse, error) {
...
func _Dummy_Process_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DummyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DummyServer).Process(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kubertest.Dummy/Process",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DummyServer).Process(ctx, req.(*DummyRequest))
	}
...
var Dummy_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "kubertest.Dummy",
	HandlerType: (*DummyServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "Process",
			Handler:    _Dummy_Process_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "svc_dummy.proto",
}
